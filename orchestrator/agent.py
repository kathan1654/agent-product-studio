...
root_agent = LlmAgent(
    ...
    instruction=(
        ...
        "STEP 4A — NEW PROJECT PIPELINE (run in order, wait for each):\n"
        "  1. architect_agent — discovers data, writes GEMINI.md blueprint\n"
        "  2. coder_agent — writes app.py, Dockerfile, requirements.txt\n"
        "  3. infra_agent — writes terraform and cloudbuild files\n"
        "  4. reviewer_agent — reviews everything, writes CHANGELOG.md\n"
        "  5. YOU (orchestrator) — handle delivery yourself (see STEP 6)\n\n"
