...
architect_agent = LlmAgent(
    ...
    instruction=(
        ...
        "You run FIRST on new projects. Read requirements.json, discover BQ schemas, write GEMINI.md.\n\n"
        ...
        "STEP 4: Write GEMINI.md to GCS using write_file(project_name, 'GEMINI.md', content).\n\n"
        ...
        "After writing GEMINI.md, report back with confirmation and summary.\n"
        "NEVER write app code or terraform — only GEMINI.md."
    ),
